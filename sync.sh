...
if [ "$NOTE_SYNC_ENABLED" = "true" ]; then
  ...
  tables=(
      "ZSFNOTE:Z_PK, Z_ENT, Z_OPT, ZARCHIVED, ZENCRYPTED, ZHASFILES, ZHASIMAGES, ZHASSOURCECODE, ZLOCKED, ZORDER, ZPERMANENTLYDELETED, ZPINNED, ZSHOWNINTODAYWIDGET, ZSKIPSYNC, ZTODOCOMPLETED, ZTODOINCOMPLETED, ZTRASHED, ZVERSION, ZPASSWORD, ZSERVERDATA, ZARCHIVEDDATE, ZCONFLICTUNIQUEIDENTIFIERDATE, ZCREATIONDATE, ZLOCKEDDATE, ZMODIFICATIONDATE, ZORDERDATE, ZPINNEDDATE, ZTRASHEDDATE, ZCONFLICTUNIQUEIDENTIFIER, ZENCRYPTIONUNIQUEIDENTIFIER, ZLASTEDITINGDEVICE, ZSUBTITLE, ZTEXT, ZTITLE, ZUNIQUEIDENTIFIER"
      "ZSFNOTEFILE:Z_PK, Z_ENT, Z_OPT, ZDOWNLOADED, ZFILESIZE, ZINDEX, ZPERMANENTLYDELETED, ZSKIPSYNC, ZUNUSED, ZUPLOADED, ZVERSION, ZNOTE, ZSERVERDATA, ZANIMATED, ZHEIGHT, ZWIDTH, ZDURATION, ZHEIGHT1, ZWIDTH1, ZCREATIONDATE, ZINSERTIONDATE, ZMODIFICATIONDATE, ZSEARCHTEXTDATE, ZUNUSEDDATE, ZUPLOADEDDATE, ZFILENAME, ZLASTEDITINGDEVICE, ZNORMALIZEDFILEEXTENSION, ZSEARCHTEXT, ZUNIQUEIDENTIFIER"
  )
